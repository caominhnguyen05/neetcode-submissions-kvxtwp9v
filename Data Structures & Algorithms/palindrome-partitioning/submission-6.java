class Solution {
    ...
    private void backtrack(
        List<List<String>> res, List<String> curr, int startIndex, boolean[][] dp, String s) {
    ...
    // Time: O(n * 2^n) - 2^(n-1) possible partitions, add each partition to result list takes O(n)
    // Space: O(n^2) extra space
}
